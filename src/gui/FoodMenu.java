...
public class FoodMenu {
	...
	// Usar la clase genérica Box
	private Box<Double>[] foodBoxes;
	protected JSpinner[] numSpinner;
	public private JLabel[] foodLabel;
	...
	void addIt(JTabbedPane tabbedPane, String text) throws IOException {
		...
		file[0] = "/Users/alexishorteales/Downloads/PRIYECTOPARADIGMAS/src/image/MedSalad.png";
		file[1] = "/Users/alexishorteales/Downloads/PRIYECTOPARADIGMAS/src/image/JapanesePanNoodles.png";
		file[2] = "/Users/alexishorteales/Downloads/PRIYECTOPARADIGMAS/src/image/spaghetti.jpg";
		file[3] = "/Users/alexishorteales/Downloads/PRIYECTOPARADIGMAS/src/image/PadThai.png";
		file[4] = "/Users/alexishorteales/Downloads/PRIYECTOPARADIGMAS/src/image/RamenNoodles.png";
		file[5] = "/Users/alexishorteales/Downloads/PRIYECTOPARADIGMAS/src/image/kids_spaghetti.png";
		file[6] = "/Users/alexishorteales/Downloads/PRIYECTOPARADIGMAS/src/image/chickenRice.jpg";
		file[7] = "/Users/alexishorteales/Downloads/PRIYECTOPARADIGMAS/src/image/thaiFood.jpg";
		file[8] = "/Users/alexishorteales/Downloads/PRIYECTOPARADIGMAS/src/image/vietnamFood.jpg";
	...
	void addIt2(JTabbedPane tabbedPane, String text) throws IOException {
		...
		// Rutas a las imágenes de postres
		String basePath = "/Users/alexishorteales/Downloads/PRIYECTOPARADIGMAS/src/image/";
		fileDesserts = new String[DESSERT_ELEMENTS];
		fileDesserts[0] = basePath + "strawberry_cake.jpg";
		fileDesserts[1] = basePath + "chocolate_cake.jpg";
		...
		for (int i = 0; i < DESSERT_ELEMENTS; i++) {
			...
			gbc.gridy++; // gridy---> add one row, for dessertLabel
	...
	void addIt1(JTabbedPane tabbedPane, String text) throws IOException {
		...
		// Rutas a las imágenes de bebidas
		String basePath = "/Users/alexishorteales/Downloads/PRIYECTOPARADIGMAS/src/image/";
		fileDrinks = new String[DRINK_ELEMENTS];
		fileDrinks[0] = basePath + "raspberry.jpg";
		fileDrinks[1] = basePath + "chocalate_pudding.jpg";
		fileDrinks[2] = basePath + "blue_hawailan.jpg";
		fileDrinks[3] = basePath + "Pina.jpg";
		fileDrinks[4] = basePath + "lemon_ice.jpg";
		...
		for (int i = 0; i < DRINK_ELEMENTS; i++) {
			...
			gbc.gridy++; // gridy---> add one row, for drinkLabel
	...
	//clase genrica inicia
	public FoodMenu() {
		// Inicializar las cajas para los alimentos
		foodBoxes = new Box[9];
		for (int i = 0; i < 9; i++) {
			foodBoxes[i] = new Box<>(0.0);
		}
	}
